...
int student_comparator (void *_studentobj1, void *_studentobj2){
    student_t *student_1;
    student_1 = _studentobj1;
    student_t *student_2;
    student_2 = _studentobj2;

    if(student_1->year_of_birth == student_2->year_of_birth)
        return 0;
    return -1;
} 
